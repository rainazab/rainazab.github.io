...
document.addEventListener('DOMContentLoaded', () => {
    ...
    originalCards.forEach((card) => {
        ...
        clone.classList.remove('fade-in-up');
    ...
    function getLoopWidth() {
        ...
        return originalCards.reduce((total, card) => total + card.offsetWidth, 0) + ((originalCards.length - 1) * gap);
    }
    ...
    function tick(now) {
        ...
        if (!isPaused) {
            gallery.scrollLeft += (speedPxPerSecond * delta) / 1000;
